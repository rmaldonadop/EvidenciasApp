...
class CarrerasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carrera" do
    assert_difference('Carrera.count') do
      post carreras_url, params: { carrera: { codigo: @carrera.codigo, escuela_id: @carrera.escuela_id, jefe_carrera: @carrera.jefe_carrera, nombre: @carrera.nombre } }
    end
  ...
  test "should update carrera" do
    patch carrera_url(@carrera), params: { carrera: { codigo: @carrera.codigo, escuela_id: @carrera.escuela_id, jefe_carrera: @carrera.jefe_carrera, nombre: @carrera.nombre } }
