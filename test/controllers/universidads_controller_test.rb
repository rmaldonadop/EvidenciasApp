...
class UniversidadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create universidad" do
    assert_difference('Universidad.count') do
      post universidads_url, params: { universidad: { casa_matriz: @universidad.casa_matriz, codigo: @universidad.codigo, direccion: @universidad.direccion, nombre: @universidad.nombre } }
    end
  ...
  test "should update universidad" do
    patch universidad_url(@universidad), params: { universidad: { casa_matriz: @universidad.casa_matriz, codigo: @universidad.codigo, direccion: @universidad.direccion, nombre: @universidad.nombre } }
